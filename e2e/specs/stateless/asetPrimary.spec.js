...
describe('Set Primary Name', () => {
  ...
  describe('profile', () => {
    describe('differening ETH record', () => {
      it('should show primary name action in profile dropdown', () => {
        cy.visit('/profile/other-eth-record.arb')
        connectFromExisting()
      ...
      it('should allow setting ETH record', () => {
        ...
        cy.findByTestId('display-item-name-normal').should('contain.text', 'other-eth-record.arb')
      ...
      it('should show changes in settings', () => {
        ...
        wrapper.should('include.text', 'other-eth-record.arb')
      })
    })
  ...
  describe('settings', () => {
    ...
    it('should allow setting primary name', () => {
      cy.findByTestId('radiogroup').then((el) => {
        cy.wrap(el).findByText('other-eth-record.arb').click()
      })
